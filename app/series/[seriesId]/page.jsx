...
export default function SeriesId() {
  ...
  return (
    <>
      <header class="">
        <div class=" bg-no-repeat bg-cover bg-center xl:bg-size-[80%_100%] xl:bg-top-left" style={{ backgroundImage: `url(https://image.tmdb.org/t/p/original/${data.backdrop_path}) , url('/images/default-bg.jpg')` }}>
          <div class="px-4 py-6 md:py-10 lg:px-13 bg-linear-to-r from-gray-950/10 to-gray-950 to-80%">
            <div class="flex items-center gap-1 text-[11px] text-gray-300">
              ...
              <Link href="/" class="transition-all duration-300 cursor-pointer hover:text-orange-400">
                خانه
              </Link>
              ...
              <Link href="/series" class="transition-all duration-300 cursor-pointer hover:text-orange-400">
                سریال ها
              </Link>
              <svg width="12px" height="12px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              ...
              <span class="transition-all duration-300 cursor-pointer hover:text-orange-400">{data.original_name}</span>
            </div>
            <div class="flex flex-wrap xs:flex-nowrap gap-6 sm:gap-6 items-start  justify-between my-5 xl:my-8 lg:gap-8">
              <div class="flex flex-col items-center grow  gap-9 max-w-[80%] mx-auto xs:max-w-[30%] md:max-w-[25%] xl:max-w-67.5">
                <div class="flex items-center gap-1">
                  <span class="text-xs text-gray-400 ">10/</span>
                  <span class=" text-white font-extrabold lg:text-xl xl:text-3xl ">{data.vote_average?.toFixed(1)}</span>
                ...
                <div class="relative group z-1 grow  min-w-full h-auto">
                  <div class=" w-full absolute  bg-cover -z-1 h-full top-0 left-0 rounded-lg contrast-85 scale-x-80 -translate-y-4 group-hover:translate-y-0 group-hover:opacity-0  transition-all duration-300" style={{ backgroundImage: `url('https://image.tmdb.org/t/p/original/${data.poster_path}_low')` }}></div>
                  <div class=" w-full absolute  bg-cover -z-1 h-full top-0 left-0 rounded-lg contrast-90 scale-x-90 -translate-y-2 group-hover:translate-y-0 group-hover:opacity-0  transition-all duration-300" style={{ backgroundImage: `url('https://image.tmdb.org/t/p/original/${data.poster_path}_low')` }}></div>
                  <Image width={280} height={500} class=" object-cover  z-50 rounded-lg contrast-110 loading-animation" src={`https://image.tmdb.org/t/p/original${data.poster_path}_medium`} alt={data.original_name + data.id} />
                  <button class="absolute top-1/1 left-1/2 -translate-1/2 flex justify-center items-center border border-orange-400 hover:bg-transparent transition-all duration-300 w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-orange-400">
                ...
                <div class="flex items-center w-full justify-center  gap-2 sm:hidden">
                  ...
                  <span class="bg-gray-500/70 w-1/2 text-xs rounded-lg overflow-hidden divide-x-1 divide-gray-300/50 flex items-end gap-1 text-orange-400 ">
                    <a href="javascript:void(0)" class=" py-2 w-1/2 group">
                      {/* <svg class="cursor-pointer mx-auto fill-gray-300 group-hover:fill-orange-400 transition-all duration-300" fill="#" height="15px" width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.2 490.2" xml:space="preserve">
                    ...
                    <a href="javascript:void(0)" class="py-2 w-1/2 group ">
                      {/* <svg class=" cursor-pointer mx-auto fill-gray-300 group-hover:fill-orange-400 transition-all duration-300" fill="#" height="15px" width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.3 490.3" xml:space="preserve">
                      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                      <g id="SVGRepo_iconCarrier">
                        {" "}
              ...
              <div class="flex flex-col  gap-6 sm:gap-4 grow w-7/10 sm:mt-8  md:gap-2 ">
                <div class="flex items-start justify-between  ">
                  <p class="text-white relative font-extrabold px-2 before:content[''] before:absolute before:w-1.5 before:h-4 before:left-1/1 before:top-1/2 before:-translate-y-1/2 before:bg-orange-400 before:rounded-full  lg:text-xl xl:text-2xl">{data.original_name}</p>
                  <div class="hidden sm:flex flex-col items-center ">
                    <div class="flex items-center w-full text-xs divide-x divide-gray-500 xl:text-sm">
                      <span class="flex items-center px-2 group gap-1 cursor-pointer text-white  hover:text-orange-400 transition-all duration-300">
                        {/* <svg class=" fill-white group-hover:rotate-[360deg] group-hover:fill-orange-400 transition-all duration-300" fill="#" height="15px" width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.2 490.2" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width=""></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                      ...
                      <span class="flex items-start px-2 group gap-1 cursor-pointer text-white  hover:text-orange-400 transition-all duration-300">
                        نپسندیدن
                        {/* <svg class=" fill-white group-hover:rotate-[360deg] group-hover:fill-orange-400 transition-all duration-300" fill="#" height="15px" width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.3 490.3" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                    ...
                    <span class="text-orange-300 text-xs mt-1 xl:text-sm">100% (1رای)</span>
                  </div>
                </div>
                <div class="flex flex-col  justify-between gap-4 grow sm:gap-8 md:flex-row  ">
                  <div class="flex flex-col gap-6 sm:gap-5 md:w-6/10 xl:w-6/10 md:gap-8 md:py-5 ">
                    <div id="genres" class="flex flex-wrap items-center gap-2 md:gap-3.5 text-gray-300 text-[11px] lg:text-sm">
                      {data.genres?.map((gen) => (
                        <Link key={gen.id} href={`/search?${gen.id}`} class="px-2.5 py-0.5 rounded-full border border-gray-400 hover:border-orange-400 hover:text-orange-400 transition-all duration-300">
                          {genres[gen.id]}
                        </Link>
                      ))}
                    </div>
                    {data.tagline && <p class="text-sm text-white font-extrabold leading-5 lg:text-base xl:text-base">{data.tagline}</p>}
                    {data.overview && <p class=" text-xs text-gray-300 leading-5 lg:text-sm xl:text-base lg:leading-8 ">{data.overview}</p>}
                    <div class="flex items-center gap-5">
                      ...
                      <div class="flex items-center gap-2 text-sm text-gray-300">
                        {/* <svg width="22px" height="22px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet" fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                    ...
                    <div class="flex items-center gap-2 text-xs text-white sm:w-1/2 md:w-auto ">
                      <button id="video-play-btn" class=" bg-orange-400 rounded-xl py-2 lg:py-3 md:px-5  grow md:grow-0  flex items-center justify-center gap-1">
                      ...
                      <button class=" bg-gray-800 rounded-xl py-2 lg:py-3 md:px-5  grow md:grow-0 flex items-center justify-center gap-1">
                  ...
                  <div class="hidden sm:flex md:flex-wrap overflow-hidden rounded-lg divide-x md:divide-x-0 bg-gray-900/30 md:justify-between md:py-5 md:bg-transparent divide-black md:grid md:grid-cols-2 md:gap-3  md:w-4/10 xl:w-3/10">
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
                        {/* <svg width="15px" height="15px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffad49">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                          <title>cc [#ffad49]</title> <desc>Created with Sketch.</desc> <defs> </defs>{" "}
                          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            {" "}
                            <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -4039.000000)" fill="#ffad49">
                              {" "}
                    ...
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      ...
                      <span class="text-white opacity-80  ">{data.number_of_seasons}</span>
                    </div>
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
                        {/* <svg width="20px" height="20px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffad49">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                      ...
                      <span class="text-white opacity-75 text-[11px] lg:text-sm">{data.origin_country}</span>
                    </div>
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
                        {/* <svg fill="#ffad49" height="20px" width="20px" version="1.1" id="Icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                          {" "}
                          <path d="M12,0C5.38,0,0,5.38,0,12s5.38,12,12,12s12-5.38,12-12S18.62,0,12,0z M12,22C6.49,22,2,17.51,2,12S6.49,2,12,2 s10,4.49,10,10S17.51,22,12,22z M10.5,10h3v8h-3V10z M10.5,5h3v3h-3V5z"></path>{" "}
                        </g>
                      </svg> */}
                        <span class="text-white text-[10px] font-bold lg:font-normal lg:text-sm">وضعیت:</span>
                      </div>
                      <span class="text-white opacity-75 text-[11px] lg:text-sm">{data.status === "Ended" ? "پایان یافته" : "در حال پخش"}</span>
                    </div>
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
                      ...
                      <span class="text-white opacity-75 text-[11px] lg:text-sm">{`${data.first_air_date?.slice(0, 4) || ""} - ${data.last_air_date?.slice(0, 4) || "نا معلوم"}`}</span>
                    </div>
                    <div class="flex flex-col md:flex-row md:flex-wrap py-3 gap-y-1 grow  md:justify-center  items-center md:rounded-xl bg-black/45  ">
                      <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
                      ...
                      <span class="text-white opacity-75 text-[11px] lg:text-sm">{data.original_language}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="theme px-4 lg:px-13 py-7  -translate-y-5 sm:translate-y-0 sm:rounded-none overflow-hidden rounded-3xl">
        <div class="flex sm:hidden  rounded-xl divide-x bg-white dark:bg-gray-800 overflow-hidden divide-black/50 dark:divide-black ">
          ...
          <div class="flex flex-col  py-2 gap-y-1 grow items-center ">
            ...
            <span class="text-black dark:text-white opacity-75 text-[10px]">{data.number_of_seasons}</span>
          </div>
          <div class="flex flex-col  py-2 gap-y-1 grow items-center ">
            <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
              {/* <svg width="20px" height="20px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffad49">
            ...
            <span class="text-black dark:text-white opacity-75 text-[10px]">{data.origin_country}</span>
          </div>
          <div class="flex flex-col  py-2 gap-y-1 grow items-center ">
            <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
              {/* <svg fill="#ffad49" height="20px" width="20px" version="1.1" id="Icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve">
            ...
            <span class="text-black dark:text-white opacity-75 text-[10px]">{data.status === "Ended" ? "پایان یافته" : "در حال پخش"}</span>
          </div>
          <div class="flex flex-col  py-2 gap-y-1 grow items-center ">
            <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
              <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-black dark:text-white opacity-75 text-[10px]">{`${data.first_air_date?.slice(0, 4) || ""} - ${data.last_air_date?.slice(0, 4) || ""}`}</span>
          </div>
          <div class="flex flex-col  py-2 gap-y-1 grow items-center ">
            <div class="flex flex-col md:flex-row md:w-full md:justify-center gap-1 md:gap-x-2 items-center">
              <svg width="15px" height="15px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-black dark:text-white opacity-75 text-[10px]">{data.original_language}</span>
          </div>
        </div>

        <div class="flex flex-col gap-10 md:flex-row md:gap-0 md:justify-between my-7 sm:my-5">
          <div class="flex flex-col text-white md:max-w-[48%] grow">
            <div class="flex gap-2 items-center">
              ...
              <span class="text-black dark:text-white md:text-lg">بازیگران</span>
              <span class=" grow h-px bg-orange-400"></span>
            </div>
            <div class="flex justify-between gap-3 mt-4 grow">
              <div class=" flex items-center mb-5">
                <button class="p-1 cursor-pointer act-prev aspect-square rounded-full border border-gray-500 dark:border-gray-300">
              ...
              <div class="swiper actors-swiper grow">
                <div id="act-swiper" class="swiper-wrapper"></div>
              </div>
              <div class=" flex items-center mb-5">
                <button class="p-1 cursor-pointer act-next aspect-square rounded-full border border-gray-500  dark:border-gray-300">
          ...
          <div class="flex flex-col text-white md:max-w-[48%] grow">
            <div class="flex gap-2 items-center">
              <span>
                {/* <svg fill="#ff980a" version="1.1" id="Director" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="23px" height="23px" viewBox="0 0 300 300" xml:space="preserve">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    {" "}
              ...
              <span class="text-black dark:text-white md:text-lg">عوامل</span>
              <span class=" grow h-px bg-orange-400"></span>
            </div>
            <div class="flex justify-between gap-3 mt-4 grow">
              <div class=" flex items-center mb-5">
                <button class="p-1 cursor-pointer crow-prev aspect-square rounded-full border border-gray-500 dark:border-gray-300">
                  <svg class="fill-black rotate-180 dark:fill-white" width="14px" height="14px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
              ...
              <div class=" flex items-center mb-5">
                <button class="p-1 cursor-pointer crow-next aspect-square rounded-full border border-gray-500  dark:border-gray-300">
                  <svg class="fill-black  dark:fill-white" width="14px" height="14px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">

  ...
  return (
    <div className="my-11 lg:my-15 ">
      <div className="flex justify-between items-center  ">
        ...
        <Link href="/series" className="flex items-center gap-2 p-2 lg:p-3.5 text-xs lg:text-sm rounded-full hover:opacity-75 transition-colors duration-300 text-gray-500 dark:text-gray-300 bg-gray-300 dark:bg-gray-800">

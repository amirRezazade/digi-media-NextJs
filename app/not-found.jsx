  ...
  return (
    <>
      <div className="bg-[url(/images/default-bg.jpg)] bg-cover ">
        <div className="bg-black/40 flex justify-center items-center flex-col gap-4 w-full min-h-dvh pb-10 sm:pt-10 px-3">
          <div>
            <Image alt="not found" className="size-70 sm:size-80" width={250} height={250} src="/images/notFound.png" />
            <h1 className="font-bold text-lg sm:text-xl text-center text-white">صفحه مورد نظر شما یافت نشد!</h1>
          </div>

        ...
        <>
          <div className="hidden sm:flex justify-between fill-gray-300">
            <div className="flex gap-2">
              <button className="my-prev w-6 h-6 rounded-full border flex justify-center items-center border-gray-500 hover:border-gray-300 transition-colors duration-300">
                <svg width="14" height="14" viewBox="0 0 48 48" version="1" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 48 48">
                  <polygon points="17.1,5 14,8.1 29.9,24 14,39.9 17.1,43 36,24" />
                </svg>
              </button>
              <button className="my-next w-6 h-6 rounded-full border flex justify-center items-center border-gray-500 hover:border-gray-300 transition-colors duration-300 rotate-180">
                <svg width="14" height="14" viewBox="0 0 48 48" version="1" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 48 48">
                  <polygon points="17.1,5 14,8.1 29.9,24 14,39.9 17.1,43 36,24" />
                </svg>
              </button>
          ...
          <Swiper
            className="mySwiper p-4 md:mt-2 min-h-auto overflow-hidden!"
            slidesPerView={"auto"}
            centeredSlides={true}
          ...
          >
            {list.map((item) => (
              <SwiperSlide className="">
                <Link href={`/${item.media_type}/${item.id}`} className="w-50! rounded-md group flex  duration-500 ">
                  <div className="w-full flex flex-col  justify-between gap-2 h-full ">
                    <div className="relative grow rounded-md  active">
                      <img className="w-full object-cover rounded-md " src={`https://image.tmdb.org/t/p/original${item.poster_path}_medium`} alt={item.name ? item.name : item.title} />

...
export default function NavbarSearchInput(params) {
  ...
  return (
    <>
      <input type=" text" placeholder="جستجو..." className="text-sm px-3 grow outline-0 text-black dark:text-white h-full" value={query} onChange={(e) => setQuery(e.target.value)} onKeyDown={(e) => e.key === "Enter" && search()} />
      <button className="w-10 h-10 rounded-full bg-orange-300/50 flex justify-center items-center" onClick={search}>

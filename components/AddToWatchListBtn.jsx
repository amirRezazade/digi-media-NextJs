...
export default function AddToWatchListBtn({ type, id }) {
  ...
  return (
    <button className={`absolute top-1/1 left-1/2 -translate-1/2 flex justify-center items-center border border-orange-400  transition-colors duration-300 w-8 h-8 rounded-full sm:w-10 sm:h-10  ${isInWatchList ? "bg-orange-400 fill-white" : "backdrop-blur-xs hover:bg-orange-400 fill-transparent hover:fill-white"}`} onClick={addToWatchList}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fff" className="size-5">

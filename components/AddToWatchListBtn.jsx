...
export default function AddToWatchListBtn({ type, id }) {
  ...
  return (
    <button className={`absolute top-1/1 left-1/2 -translate-1/2 flex justify-center items-center border border-orange-400  transition-colors duration-300  rounded-full w-10 h-10  ${isInWatchList ? "bg-orange-400 fill-white" : "backdrop-blur-xs hover:bg-orange-400 fill-transparent "}`} onClick={addToWatchList}>
